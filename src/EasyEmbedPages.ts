import { MessageActionRow, MessageOptions as DefaultMesageOption, InteractionReplyOptions ,MessageButton, MessageEmbed, TextChannel, MessagePayload, InteractionCollector, ButtonInteraction, Message, TextBasedChannel, TextBasedChannels } from 'discord.js';

interface MessageOptions extends DefaultMesageOption, InteractionReplyOptions {
	delete?: boolean
	pageGen?: () => void
}

interface PsuedoMessage {
	// eslint-disable-next-line  @typescript-eslint/no-explicit-any
	[name: string]: any;
	edit(content: MessageOptions | MessagePayload): Promise<Message>;
	delete(): Promise<void>;
